...
struct AlphaBlendPartialDeviceOperation {
    using operation_attributes_t = AlphaBlendPartialParams;
    using tensor_args_t = AlphaBlendPartialInputs;
    using spec_return_value_t = ttnn::TensorSpec;
    using tensor_return_value_t = ttnn::Tensor;
    using program_factory_t = std::variant<AlphaBlendPartialProgramFactory>;
